    ...
    return(
        <View style={styles.container}>
            <View style={styles.containerSearch}>
                <Icon name="search"/>
                <TextInput placeholder="Pesquisar Rotas" style={styles.inputSearch}/>
            </View>
            <TouchableOpacity style={styles.containerStar} onPress={()=>navigation.navigate('Map')}>
                <Text style={styles.tittleStar}>Estrela</Text>
            ...
            <View style={styles.containerRow}>
                <TouchableOpacity onPress={()=>navigation.navigate('Perfil')} style={styles.containerProfile}>
                    ...
                    <View style={styles.containerRowProfile}>
                        <Text style={styles.tittleProfille}>Usuário</Text>
                        <Text style={styles.subtittleProfille}>R$: 610,54</Text>
                    </View>
                </TouchableOpacity>
